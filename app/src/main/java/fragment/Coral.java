 ...
 */
public class Coral extends Fragment {

    private GridView progridview;

    String[] str={"http://weburly.com/image/product112_1.jpg"};

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.coral_layout, container, false);
