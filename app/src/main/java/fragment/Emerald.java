...
public class Emerald extends Fragment {
    ...
    String[] str={"http://weburly.com/image/product115_1.jpg",
    "http://weburly.com/image/product111_1.jpg",
    "http://weburly.com/image/product102_1.jpg",
    "http://weburly.com/image/product117_1.jpg",
    "http://weburly.com/image/product118_1.jpg"};

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.emerald_layout, container, false);
